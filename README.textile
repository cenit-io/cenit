...
if you have some throuble with secret_key_base running 'rails s'. First generate a random secret key value:
...
Go to browser and visit the admin panel of Hub Demo Store 1.
...
Create a new product in the product form.

<img src="app/assets/images/store1.png" alt="store 1" />

You can visit data in Cenit Hub and check that the product was saved.
