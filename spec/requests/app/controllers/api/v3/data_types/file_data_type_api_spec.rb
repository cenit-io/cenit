...
RSpec.describe Api::V3::ApiController, type: :request do
  ...
  describe "GET /api/v3/setup/file_data_type" do
    ...
    context "fail retrieve all existing json_data_type "  do
      it "with missing header request" do
        get '/api/v3/setup/file_data_type', as: :json
      ...
      it "with unauthorized token request"  do
        get '/api/v3/setup/file_data_type', headers: {
    ...
    context "successful retrieve all existing file_data_type"  do
      let(:access_token) do
        app = ::Setup::Application.create!(namespace: 'Test', name: 'file_data_type')
      ...
      it "with authorized token request"  do
        get '/api/v3/setup/file_data_type', headers: access_token
