  ...
  describe "GET /api/v3/setup/connection_config.json" do
    ...
    context "fail retrieve all existing Connection configs"  do
      ...
      it "with unauthorized token request"  do
        get '/api/v3/setup/connection_config.json', headers: {
    ...
    context "successful retrieve all existing Connection configs"  do
      let(:access_token) do
        app = ::Setup::Application.create!(namespace: 'Test', name: 'Connection configs')
      ...
      it "with authorized token request"  do
        get '/api/v3/setup/connection_config.json', headers: access_token
