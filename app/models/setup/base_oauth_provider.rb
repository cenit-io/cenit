module Setup
  class BaseOauthProvider < AuthorizationProvider
    ...
    def google_v4_refresh_token(authorization)
      unless authorization.authorized_at + (authorization.token_span || 0) > Time.now - Cenit.delay_time_for_token_refresh
    ...
    def lazada_rest_api_refresh_token(authorization)
      unless authorization.authorized_at + (authorization.token_span || 0) > Time.now - Cenit.delay_time_for_lazada_token_refresh
